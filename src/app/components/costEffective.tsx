...
function costEffective({installment, cet, idTransaction, amount}: {amount:string, installment:number, cet: string, idTransaction: string}) {
  ...
  const CET = (installment === 1) ? amount : cet
